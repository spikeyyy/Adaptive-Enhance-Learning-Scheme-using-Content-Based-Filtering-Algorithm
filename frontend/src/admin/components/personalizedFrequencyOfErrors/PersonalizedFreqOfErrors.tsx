...
const PersonalizedFreqOfErrors = () => {
    ...
    const fetchErrorData = async () => {
      try {
        const response = await axios.get<StudentErrorData[]>(
          `${AUTH_API_URL}/error_frequency_per_student`
        );
  ...
  return (
    <div className="widgetLg">
      <span className="widgetLgTitle">
        Diagnostic Frequency of Errors per Subject
      </span>
...
export default PersonalizedFreqOfErrors;
