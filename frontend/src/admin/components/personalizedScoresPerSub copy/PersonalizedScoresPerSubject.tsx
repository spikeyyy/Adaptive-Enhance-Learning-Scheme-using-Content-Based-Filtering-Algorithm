...
const PersonalizedScoresPerSuject = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${AUTH_API_URL}/total_personalized_category_scores`
        );
        if (response.data) {
  ...
  return (
    <div className="widgetLg">
      <span className="widgetLgTitle">
        Diagnostic Personalized Scores per subject
      </span>
...
export default PersonalizedScoresPerSuject;
